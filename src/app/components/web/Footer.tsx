          ...
          <div className="pb-4 mb-4" style={{ borderBottom: "1px solid rgba(226, 175, 24, 0.5)" }}>
            <div className="row g-4">
              <div className="col-lg-3">
                <a href="#">
                  <h1 className="text-primary mb-0">Gardening Tools</h1>
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="d-flex flex-column text-start footer-item">
                ...
                {["About Us", "Contact Us", "Privacy Policy", "Terms & Condition", "Return Policy", "FAQs & Help"].map((l) => (
            ...
            <div className="col-lg-3 col-md-6">
              <div className="d-flex flex-column text-start footer-item">
                ...
                {["My Account", "Shop details", "Shopping Cart", "Wishlist", "Order History", "International Orders"].map((l) => (
                  <a key={l} className="btn-link" href="#">{l}</a>
                ))}
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
              <span className="text-light">
                <a href="#">
                  <i className="fas fa-copyright text-light me-2"></i>Gardening Tools
                </a>
                , All rights reserved.
              </span>
            </div>
